...
class ServerWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var state = ServerlistState.singleton;
                          ...
                          children: [
                            ...
                            if (serverData.friendlyFire)
                              Tooltip(
                                  ...
                                  message:
                                      'This Server has FriendlyFire enabled',
                                  child: Text('FF')),
                          ],
                        )
                      ],
                      ...
                      children: [
                        IconButton(
                            onPressed: () {
                              ...
                              state.addToHistory(serverData.getServerUnique());
                            },
                            icon: Icon(Icons.arrow_right)),
                        //Favorite Button
                        IconButton(
                            onPressed: () {
                              state.toggleFavorite(serverData.getServerUnique());
                            },
                            icon: Icon(state.favorites.contains(serverData.getServerUnique()) ? Icons.favorite : Icons.favorite_border)),
                      ],
                    ),
                  ],
                )),
